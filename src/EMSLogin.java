...
public class EMSLogin extends JFrame {
    ...
    private void handleLogin() {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASS)) {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(this, "User not found! Try adding a user to the database first.");
            }
    ...
    private void openDashboard(String role) {
        ...
        SwingUtilities.invokeLater(() -> {
            switch (role) {
                case "Admin":
                    new EMSAdminGUI().setVisible(true);
                    break;
                case "Organizer":
                    new EMSOrganizerGUI().setVisible(true);
                    break;
                case "Attendee":
                    new EMSGuestGUI().setVisible(true);
                    break;
    ...
    public static class GradientHeaderPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            GradientPaint gp = new GradientPaint(
                    ...
                    getWidth(), getHeight(), new Color(58, 213, 173)
            );
            g2.setPaint(gp);
